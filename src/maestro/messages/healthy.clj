  ...
  (let [{:keys [region]} parameters
    ...
    (if (uses-healthy? deployment-params)
      (do
        ...
        (if (healthy/register-auto-scaling-group region auto-scaling-group-name path port scheme timeout)
          (success parameters)
          (do
  ...
  (let [{:keys [region]} parameters
    ...
    (if (and (uses-healthy? deployment-params) auto-scaling-group-name)
      (do
        ...
        (if (healthy/deregister-auto-scaling-group region auto-scaling-group-name)
          (success parameters)
          (do
