...
(fact "that getting the sequence number of a legacy action works"
      (sequence-number :exploud.messages.health/wait-for-load-balancers-to-be-healthy) => 51)

(fact "that getting the sequence number works"
      (sequence-number :maestro.messages.health/wait-for-load-balancers-to-be-healthy) => 51)
