...
(fact "that getting application registrations for prod uses the correct url"
      ...
      (provided
       ...
       (http/simple-get "http://numelprod/registrations/prod/application" {:socket-timeout 10000}) => {:body ..body..
                                                                                                                :status 200}
...
(fact "that getting application registrations for a non-prod environment uses the correct url"
      ...
      (provided
       ...
       (http/simple-get "http://numelpoke/registrations/anything/application" {:socket-timeout 10000}) => {:body ..body..
                                                                                                                    :status 200}
       (json/parse-string ..body.. true) => ..json..))
