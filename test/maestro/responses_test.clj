...
(fact "that creating an error for an expected Pedantic response turns it into a retry"
      (error-with (ex-info "Busted" {:type :maestro.pedantic/unexpected-response})) => {:status :retry
                                                                                        :backoff-ms 5000})
