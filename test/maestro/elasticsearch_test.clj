...
(fact "that getting the deployments by user maps results correctly"
      ...
      (provided
       ...
       (esd/search anything "maestro" "deployment" :query ..query.. :size 0 :facets {:user ..user-facet..}) => {:facets {:user {:terms [{:term "user1"
                                                                                                                                         :count 1}
                                                                                                                                        {:term "user2"
                                                                                                                                         :count 2}]}}}))
...
(fact "that getting the deployments by month maps results correctly"
      ...
      (provided
       ...
       (esd/search anything "maestro" "deployment" :query anything :size 0 :facets {:date ..start-date-facet..}) => {:facets {:date {:entries [{:time 1393632000000
                                                                                                                                                :count 12}
                                                                                                                                               {:time 1396310400000
                                                                                                                                                :count 2}]}}}))
...
(fact "that getting the deployments in an environment by month maps results correctly"
      ...
      (provided
       ...
       (esd/search anything "maestro" "deployment" :query ..query.. :size 0 :facets {:date ..start-date-facet..}) => {:facets {:date {:entries [{:time 1393632000000
                                                                                                                                                 :count 12}
                                                                                                                                                {:time 1396310400000
                                                                                                                                                 :count 2}]}}}))
